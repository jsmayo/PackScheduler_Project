...
public class FacultySchedulePanel  extends JPanel implements ActionListener {
	...
	/** Faculty's FacultySchedule text field */
...
//		btnReset = new JButton("Reset FacultySchedule");
//		btnReset.addActionListener(this);
//		btnDisplay = new JButton("Display Final Schedule");
//		//		btnDisplay.addActionListener(this);
//		btnDisplay.setEnabled(false);
//		lblScheduleTitle = new JLabel("FacultySchedule Title: ");
...
//		pnlActions.setToolTipText("Scheduler Actions");
		...
		scrollCatalog.setToolTipText("Faculty Schedule");
		...
		TitledBorder borderCourseDetails = BorderFactory.createTitledBorder(lowerEtched, "Course Roll");
...
//					scrollSchedule.setToolTipText(schedule.getTitle());
	...
	private class RollTableModel extends AbstractTableModel {
		...
		/**
		 * Constructs the table by requesting the latest information
		 * from the {@link RequirementTrackerModel}.
		 */
		public RollTableModel(boolean isCatalog) {
			this.isCatalog = isCatalog;
			updateData();
		}
